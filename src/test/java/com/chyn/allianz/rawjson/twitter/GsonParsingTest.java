...
class GsonParsingTest {
	...
	@Test
	void testRawRetweetJson() {
		assertNotNull(rawRetweetJson, "RawRetweetJson null");
	}

	@Test
	void testQuotStatus() {
		assertNotNull(rawRetweetJson.getQuoted_status(), "getQuoted_status null");
		assertNotNull(rawRetweetJson.getQuoted_status().getId(), "getQuoted_status getId null");
		assertNotNull(rawRetweetJson.getQuoted_status().getUser(), "getQuoted_status getUser null");
	}
	
	void testQuotStatusGetUser() {
		assertNotNull(rawRetweetJson.getQuoted_status().getUser(), "getQuoted_status  null");
		assertNotNull(rawRetweetJson.getQuoted_status().getUser().getId(), "getQuoted_status getId null");
		assertNotNull(rawRetweetJson.getQuoted_status().getUser().getFollowers_count(), "getQuoted_status getUser getFollowers_count null");
		assertNotNull(rawRetweetJson.getQuoted_status().getUser().getFriends_count(), "getQuoted_status getUser getFriends_count null");
	}
	
	@Test
	void testUser() {
		assertNotNull(rawRetweetJson.getUser(), "getUser null");
		assertNotNull(rawRetweetJson.getUser().getId(), "getQuoted_status getId null");
		assertNotNull(rawRetweetJson.getUser().getFollowers_count(), "getQuoted_status getFollowers_count null");
		assertNotNull(rawRetweetJson.getUser().getFriends_count(), "getQuoted_status getFriends_count null");
	}
}
